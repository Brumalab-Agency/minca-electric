...
const Minca1600hs = () => {
  ...
  return (
    <div className="carrusel relative grid h-[494px] 2xl:h-[850px] grid-cols-12 grid-rows-12 bg-[#878D8F] px-4 lg:h-[663px] lg:grid-cols-12 lg:grid-rows-12 lg:px-[48px] overflow-hidden">
      <div className="pointer-events-none col-span-full row-span-full grid h-auto w-full place-items-center overflow-hidden bg-[url('/scooterHotsSpot/1600W.png')] bg-[length:77%] lg:bg-[length:32%] 2xl:bg-[length:23%] bg-no-repeat bg-center">
        <Image
