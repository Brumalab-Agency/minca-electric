...
const Minca350hs = () => {
  ...
  return (
    <div className="carrusel relative grid h-[494px] 2xl:h-[850px] grid-cols-12 grid-rows-12 bg-[#878D8F] px-4 lg:h-[663px] lg:grid-cols-12 lg:grid-rows-12 lg:px-[48px] overflow-hidden">
      <div className="pointer-events-none col-span-full row-span-full grid h-auto w-full place-items-center overflow-hidden bg-[url('/scooterHotsSpot/350W.png')] bg-[length:77%] lg:bg-[length:32%] 2xl:bg-[length:23%] bg-no-repeat bg-center">
        <Image
          className="lg:w-[40%] 2xl:w-[30%]"
          placeholder="empty"
          alt="scooter"
          src="/scooterHotsSpot/minca350whotspot.png"
          priority={true}
          width={569}
          height={570}
        />
      ...
      <section
        className="btn-pulse markers  left-[50%] -top-[7%] col-span-1 row-span-1 lg:-top-[7%] lg:left-[38%] 2xl:-top-[1%] 2xl:left-[36%]"
      ...
      <section
        className="btn-pulse markers  right-[33%] -top-[36%] col-span-1 row-span-1 lg:right-[46%] lg:-top-[38%] 2xl:right-[48%] 2xl:-top-[33%]"
      ...
      <section
        className="btn-pulse markers  col-span-1 row-span-1 left-[27%] top-[17%] lg:left-[40%] lg:bottom-[74%] 2xl:left-[43%] 2xl:-top-[5%]"
      ...
      >
       ...
       {/* Markers 5 Llanta*/}
       <section
        className="btn-pulse markers  left-[4%] top-[22%] col-span-1 row-span-1 lg:left-[31%] lg:bottom-[50%] 2xl:left-[36%] 2xl:-top-[5%]"
        style={{ gridColumn: "2 / 12", gridRow: "9 / 12" }}
      >
      ...
      >
       ...
       <section
        className="btn-pulse markers col-span-1 row-span-1 left-[16%] bottom-[88%] lg:left-[37%] lg:top-[20%] 2xl:left-[40%] 2xl:top-[5%]"
        style={{ gridColumn: "2 / 12", gridRow: "9 / 12" }}
      >
      ...
      <section
        className="btn-pulse markers  col-span-1 row-span-1 left-[20%] lg:-left-[6%] lg:top-[13%] 2xl:-left-[9%] 2xl:-top-[8%]"
      ...
      <section
        className="btn-pulse markers  col-span-1 row-span-1 left-[66%] -top-[19%] lg:left-[11%] lg:-top-[6%] 2xl:left-[3%] 2xl:-top-[17%]"
        style={{ gridColumn: "8 / 12", gridRow: "9 / 12" }}
      >
      ...
      <section
        className="btn-pulse markers  left-[50%] -top-[5%] col-span-1 row-span-1 lg:left-[6%] lg:top-[5%] 2xl:-left-[1%] 2xl:-top-[8%]"
        style={{ gridColumn: "8 / 12", gridRow: "9 / 12" }}
      >
      ...
      {/* Markers 11 Llanta*/}
      <section
        className="btn-pulse markers  left-[70%] top-[15%] col-span-1 row-span-1 lg:left-[13%] lg:top-[23%] 2xl:left-[4%] 2xl:top-[14%]"
        style={{ gridColumn: "8 / 12", gridRow: "9 / 12" }}
      >
