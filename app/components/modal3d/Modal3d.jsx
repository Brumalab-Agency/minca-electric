        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="max-h-[300px] lg:max-h-[600px] w-full max-w-[300px] lg:max-w-[600px] transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all relative">
                    <img className="w-[30%] h-auto" src="/logo.png" alt="logo minca" />
                  <div className="w-full h-full grid place-items-center">
                    <div className="h-[300px] lg:h-[600px] w-[300px] lg:w-[600px]">
                      <Spline scene={url_3d} />
                    </div>
                  </div>
