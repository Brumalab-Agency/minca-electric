...
export const Section4 = () => {
  return (
    <div className="carrusel w-auto h-[571px] lg:h-[618px] px-4 lg:px-[48px] bg-[#F4F5F0] lg:bg-white">
        <section className="lg:flex w-full h-auto lg:h-full bg-[#F4F5F0] grid place-items-center">
            <div className="w-full h-auto lg:h-full">
              <div className="mt-[46px] lg:mt-0 lg:flex justify-center items-center flex-col lg:h-full">
                  <h1 className={`${manrope.className} lg:w-[495px] h-auto lg:font-bold font-light text-[40px] lg:text-[42px] lg:uppercase normal-case lg:leading-[45px] leading-[50px] text-left`}>
