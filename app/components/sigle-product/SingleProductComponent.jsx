...
export const SingleProductComponent = async ({scooters}) => {
  const producto = "Minca 350W";
  const productoBuscado = scooters.edges.find(edge => edge.node?.sliderProductos.nombreProducto === producto);
  const item = productoBuscado?.node.sliderProductos;
  return (
