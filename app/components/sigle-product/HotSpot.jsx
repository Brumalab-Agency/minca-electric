...
export const HotSpot = (scooters) => {
  ...
  return (
    <div className="carrusel relative grid h-[494px] grid-cols-12 grid-rows-12 bg-[#878D8F] px-4 lg:h-[663px] lg:grid-cols-12 lg:grid-rows-12 lg:px-[48px] overflow-hidden">
