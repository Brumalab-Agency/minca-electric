  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <option value="Carolina del principe">Carolina del principe</option>
        ...
        <option value="Donmatias">Donmatias</option>
        <option value="Doradal">Doradal</option>
        ...
        <option value="Jardin caceres">Jardin caceres</option>
        <option value="Jardin suroeste">Jardin suroeste</option>
        <option value="Jerico">Jerico</option>
        <option value="La ceja">La ceja</option>
        <option value="La cruzada">La cruzada</option>
        ...
        <option value="Llanadas">Llanadas</option>
        <option value="Llanos de cuivá">Llanos de cuivá</option>
        ...
        <option value="Nueva colonia">Nueva colonia</option>
        ...
        <option value="Puerto belgica">Puerto belgica</option>
        ...
        <option value="Puerto valdivia">Puerto valdivia</option>
        ...
        <option value="San jose del nus">San jose del nus</option>
        <option value="San juan de uraba">San juan de uraba</option>
        <option value="San luis">San luis</option>
        <option value="San miguel">San miguel</option>
        <option value="San pedro de los milagros">
        ...
        <option value="Santa isabell">Santa isabell</option>
        ...
        <option value="Yondo casabe">Yondo casabe</option>
        <option value="Zaragoza">Zaragoza</option>
        <option value="Zungo carretera">Zungo carretera</option>
      </select>
      <span
