    ...
    <>
      <div className="heroImagen relative lg:mt-4">
        <div className="mt-4">
          ...
          {/* <video
            className="top-0 hidden h-[663px] w-full object-cover  lg:block"
            src={`${banner[1].node.banner.videoBannerPc.mediaItemUrl}`}
            autoPlay
            muted
            loop
          /> */}
          ...
          {/* <div className="overlay absolute top-0 flex h-[400px] w-full flex-col items-start justify-center bg-[#111]/50 p-4 lg:h-[663px] lg:px-[100px]">
            <div className="lg:flex lg:w-full lg:justify-between">
              <div className={`grid text-[50px] text-white lg:text-[64px]`}>
                <div className="flex flex-col items-start justify-center">
                  <span className="font-light">MINCA</span>
                  <span className="-mt-6 font-bold lg:-mt-8">Mopeds</span>
                </div>
              </div>
              <div>
                <Image
                  placeholder="empty"
                  alt="publicidad"
                  className="logo-minca-m hidden shadow-none lg:block"
