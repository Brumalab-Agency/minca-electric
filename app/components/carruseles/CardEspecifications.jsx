...
export const CardEspecifications = ({ titulo, subtitulo, tipo }) => {
  return (
    <div className="cards rounded-[6px] bg-[#F0EEED]  w-[72px] h-[65px] py-[10px] flex flex-col justify-between items-center 2xl:w-[148px] lg:w-[130px] lg:h-[116px] lg:py-[35px] lg:justify-evenly flex-none">
      <p
