...
const TituloCardHoverEffect = () => {
  return (
    <div className='bg-[#111] px-8 w-full -mb-1'>
        <div className={` ${manrope.className} text-[32px] font-bold text-white w-full pt-10 text-left lg:px-10 max-w-[1270px] mx-auto`}>
            <h2>Equipo Minca: tu guía profesional</h2>
            <p className='text-[28px] leading-[33px] font-normal mt-4'>Nuestro equipo de expertos en movilidad eléctrica está dedicado a ofrecerte la mejor experiencia en nuestros showrooms Minca.</p>
