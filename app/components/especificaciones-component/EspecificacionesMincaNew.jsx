  ...
  const garantiaUrl =
    ...
    const handleCodigoOCChange = async (e) => {
      ...
      if (status && status === 'completed') {
        ...
        item.sliderProductos.precioActual = selectedPaymentOption;
      }
    };
    ...
    <div className="lg:w-[50%]">
      ...
      <div className="flex justify-between lg:ml-7">
        <div className="flex flex-col justify-center">
          ...
          {item.title === "Scooter Eléctrico Minca 350W" && (
            <form>
              <div className="mb-4 flex items-center space-x-2">
                <h4 className="inline-block text-xl font-semibold">Preventa</h4>
