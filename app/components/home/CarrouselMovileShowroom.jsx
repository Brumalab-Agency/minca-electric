...
export const CarrouselMovileShowroom = () => {
  ...
  const slides = [
    {
      img: "/sedes/Showroom Chicó - Minca electric.jpg",
      title: "Showroom Chicó",
      link: "/testdrive/showroomchico",
      location: "Cra. 11a #94a-56",
    ...
    {
      img: "/sedes/Showroom Javeriana - Minca electric.jpg",
      title: "Showroom Javeriana",
      link: "/testdrive/showroomjaveriana",
      location: "Cra. 7 #45-10",
      location2: "Bogotá, Colombia",
      schedule: [
        "Lunes a viernes: 11:00 a.m. - 08:00 p.m.",
        "Sábados: 09:00 a.m. - 08:00 p.m.",
    ...
    {
      img: "/sedes/Showroom Cedritos - Minca electric.png",
      title: "Showroom Cedritos",
      link: "/testdrive/showroomcedritos",
      location: "Av. Cra. 19#143A-08",
      location2: "Bogotá, Colombia",
      schedule: [
        "Lunes a viernes: 11:00 a.m. - 08:00 p.m.",
        "Sábados: 09:00 a.m. - 08:00 p.m.",
    ...
    {
      img: "/sedes/Showroom Gran Estación - Minca electric.jpg",
      title: "Showroom Gran Estación",
      link: "#",
      location: "C. Comercial Gran Estacion Isla, 2-02",
      location2: "Bogotá, Colombia",
      schedule: [
        "Lunes a viernes: 11:00 a.m. - 08:00 p.m.",
        "Sábados: 09:00 a.m. - 08:00 p.m.",
    ...
    {
      img: "/sedes/Showroom Avenida Chile - Minca electric.jpg",
      title: "Showroom Avenida Chile",
