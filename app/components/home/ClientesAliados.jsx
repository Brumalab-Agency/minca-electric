      ...
      <div className="mt-[42px] grid grid-cols-4 lg:grid-cols-6 gap-4 lg:mt-[40px]">
        {data.map((item) => (
          <div
            ...
            className="custom-shadow flex h-[32px] w-[76px] items-center justify-center rounded-[5px] bg-[#F0EEED] lg:h-[75px] lg:w-[191px] 2xl:w-[270px] 2xl:h-[105px] lg:mb-[53px] 2xl:mb-[74px]"
          >
            <img
