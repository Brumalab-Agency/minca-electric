...
const PasoaPaso = ({inactivo1, inactivo2, inactivo3}) => {
  return (
    <div className="w-full h-[150px] mt-[130px]">
      <div className="relative m-auto grid h-[30px] w-[500px] grid-cols-3 place-items-center">
      ...
      <div className="relative m-auto grid h-[15px] w-[500px] grid-cols-3 place-items-center">
        <p>Tus datos</p>
        <p>Pago</p>
        <p>Pedido terminado</p>
      </div>
    </div>
  );
};
