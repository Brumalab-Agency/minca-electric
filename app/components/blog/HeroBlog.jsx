...
export const HeroBlog = () => {
  return (
    <div className="HeroBlog lg:min-h-[710px] mt-[45px]">
        <div className="relative flex justify-center lg:justify-start">
            <div className="w-full h-[313px] bg-[url(/blog/bg-blog.jpg)] bg-top bg-cover lg:w-[90%] lg:h-[603px] rounded-[12px] m-auto lg:rounded-none"></div>
            {/* *** */}
            <div className="card-blog w-[90%] h-[273px] bg-white rounded-[12px] p-[40px] absolute bottom-0 top-[60%] shadow-md lg:w-[598px] lg:h-[263px] lg:ml-[192px] lg:top-[75%]">
